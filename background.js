...
function syncSettings() {
    chrome.storage.sync.get(DEFAULTS, function (obj) {
      ...
      let text = options.redirectAssets ? '​' : '​'; 
...
const ANIMATION_REDIRECT_TEMPLATE = 'https://mafia-assets.github.io/assets/assets/animations/'; // redirect URLs are all from this
...
const CHAR_REDIRECT_TEMPLATE = 'https://mafia-assets.github.io/assets/assets/characters/'; // redirect URLs are all from this
...
const SPRITESHEET_REDIRECT_TEMPLATE = 'https://mafia-assets.github.io/assets/assets/spritesheets/'; // redirect URLs are all from this
...
const MAP_SPRITESHEET_REDIRECT_TEMPLATE = 'https://mafia-assets.github.io/assets/assets/packs/'; // redirect URLs are all from this
...
const IMG_REDIRECT_TEMPLATE = 'https://mafia-assets.github.io/assets/img/'; // redirect URLs are all from this
...
const PET_REDIRECT_TEMPLATE = 'https://mafia-assets.github.io/assets/custom/pets/';
...
const SKIN_REDIRECT_TEMPLATE = 'https://mafia-assets.github.io/assets/assets/skins/'; // redirect URLs are all from this
const CDN_SKIN_REDIRECT_TEMPLATE = 'https://mafia-assets.github.io/assets/assets/skins/custom/'; // redirect URLs are all from this
...
const MISC_REDIRECT_TEMPLATE = 'https://mafia-assets.github.io/assets/assets/'; // redirect URLs are all from this
